...
### 2.1-Crie um Aplicativo no Spotify Developers:
...
### 2.2-Configure o Redirecionamento (Redirect URI):
...
### 2.3-Atualize o Client ID no Código:

Abra o arquivo js/spotify.js.

Substitua o valor da constante SPOTIFY_CLIENT_ID pelo seu ID gerado, garantindo que o bloco seja exibido corretamente no README:
...
### 3.1-Abra a pasta do projeto no VS Code.

### 3.2-Clique com o botão direito no index.html e selecione "Open with Live Server".

### 3.3-O navegador deve abrir o projeto na URI configurada (http://127.0.0.1:5500/).
